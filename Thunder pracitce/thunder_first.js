...
window.onload = function(){
    ...
    obBtn.onclick = function(){
        //oDiv2.style.display = "block";   //假设这个优先级高，能生效
        //oDiv1.style.top = -(real_height) + "px";
        //oDiv2.style.top = 0;
        //setmover(oDiv2,{top:0});
        //setmover(oDiv1,{top:-(real_height)});
    ...
    //    $("#fsc_t").change(function(){
    //        var value = $("#fsc_t").val().length;
    //        alert(value);
    //        if(value !== 0){
    //            $("#fsb_a").css("background-color","#0f97ff");
    //        }else{
